...
void ParameterService::initializeParameterMap() {
    parameters = {{PeakSatParameters::OBCMCUTemperature,                 PeakSatParameters::obcMCUTemperature},
            ...
            //---------------------------------------------------------------------------------------------
                  {PeakSatParameters::COMMSUHFPATemperature,             PeakSatParameters::commsUHFBandPATemperature},
                  {PeakSatParameters::COMMSPCBTemperature,               PeakSatParameters::commsPCBTemperature},
                  {PeakSatParameters::COMMSADMStatus,                    PeakSatParameters::commsAntennaDeploymentStatus},
                  {PeakSatParameters::COMMSUHFTXDataRate,                PeakSatParameters::commsUHFTXDataRate},
                  {PeakSatParameters::COMMSUHFRXDataRate,                PeakSatParameters::commsUHFRXDataRate},
                  ...
                  {PeakSatParameters::COMMSChannelNoUHFBand,             PeakSatParameters::commsChannelNoUHFBand},
                  ...
                  {PeakSatParameters::COMMSUHFBandTXOn,                  PeakSatParameters::commsUHFBandTXOnOff},
                  {PeakSatParameters::COMMSUHFBandRXOn,                  PeakSatParameters::commsUHFBandRXOnOff},
                  {PeakSatParameters::COMMSNoOfRejectedPackets,          PeakSatParameters::commsPacketsRejectedCOMMS},
                  ...
                  {PeakSatParameters::COMMSMCUBootCount,                 PeakSatParameters::commsMCUBootCounter},
                  {PeakSatParameters::COMMSMCUTime,                      PeakSatParameters::commsOnBoardTime},
                  {PeakSatParameters::COMMSMemoryPartition,              PeakSatParameters::commsNANDCurrentlyUsedMemoryPartition},
